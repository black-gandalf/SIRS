 ...
 * wsimport.
 */
public class SecureChildLocatorClient implements SecureChildLocatorPortType {
	...
	public SecureChildLocatorClient(String wsURL) throws SecureChildLocatorClientException {
		this.wsURL = wsURL;
		createStub();
	}
